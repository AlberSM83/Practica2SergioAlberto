...
Por último vamos a intentar ver si podemos obtener regresión lineal entre el precio y la edad. De ser así, lo que estaríamos indicando es que cuanto mayores son las personas, tarifas más altas pagan, lo cual no tiene por qué ser así.
